<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('files.get') }}" :active="request()->routeIs('files.get')">
                        {{ __('Archivos Recibidos') }}
                    </x-jet-nav-link>
                    @can('Ver Usuarios')
                    ...
                    @endcan
                    @can('Ver Auditoria')   
                        <div class="sm:flex sm:items-center sm:ml-6 cursor-pointer">
                            <div class="ml-3 relative">
                                <x-jet-dropdown align="left" width="48">
                                    ...
                                    <x-slot name="content">
                                        <x-jet-dropdown-link href="{{route('audits.users')}}">
                                            {{ __('Auditoria de Usuarios') }}
                                        </x-jet-dropdown-link>
                                        <x-jet-dropdown-link href="{{route('audits.files')}}">
                                            {{ __('Auditoria de Archivos') }}
                                        </x-jet-dropdown-link>
                                    </x-slot>
                                </x-jet-dropdown>
                            </div>
                ...
                <div class="ml-3 relative">
                    <x-jet-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-jet-dropdown-link href="javascript:void(0)" onclick="openModal('main-modal')">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-jet-responsive-nav-link href="{{ route('files.get') }}" :active="request()->routeIs('files.get')">
                {{ __('Archivos Recibidos') }}
            </x-jet-responsive-nav-link>
            <x-jet-responsive-nav-link href="{{ route('files.get') }}" :active="request()->routeIs('files.get')">
                {{ __('Auditoria de Archivos') }}
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                <!-- Account Management -->
                <x-jet-responsive-nav-link onclick="openModal('main-modal')" href="javascript:void(0)" :active="request()->routeIs('profile.show')">
                    {{ __('Cambiar contraseña') }}
                </x-jet-responsive-nav-link>
